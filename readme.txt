...
3. checkpoints folder
Store the checkpoints and the final result (epoch 500 relative) model. The sample images are also generated for monitor process and assessment.
Owing to the limitation of upload file size, only limited model file are reserved (epoch 50, 100, 450 and 500)
